import { ToolCall, ToolMessage } from "../../src/messages/tool.js";
import { InferInteropZodInput, InferInteropZodOutput, InteropZodObject, InteropZodType, ZodObjectV3, ZodObjectV4, ZodStringV3, ZodStringV4 } from "../../src/utils/types/zod.js";
import { CallbackManagerForToolRun } from "../../src/callbacks/manager.js";
import { RunnableConfig } from "../../src/runnables/types.js";
import { RunnableFunc, RunnableToolLike } from "../../src/runnables/base.js";
import { JsonSchema7Type } from "../../src/utils/zod-to-json-schema/parseTypes.js";
import { BaseLangChain } from "../../src/language_models/base.js";
import { ToolInputParsingException } from "../../src/tools/utils.js";
import { BaseDynamicToolInput, ContentAndArtifact, DynamicStructuredToolInput, DynamicToolInput, InferToolEventFromFunc, InferToolOutputFromFunc, ResponseFormat, StringInputToolSchema, StructuredToolCallInput, StructuredToolInterface, StructuredToolParams, ToolEventType, ToolInputSchemaBase, ToolInputSchemaInputType, ToolInputSchemaOutputType, ToolInterface, ToolOutputType, ToolParams, ToolReturnType, ToolRunnableConfig, ToolRuntime, isLangChainTool, isRunnableToolLike, isStructuredTool, isStructuredToolParams } from "../../src/tools/types.js";
...
declare class DynamicTool<ToolOutputT = ToolOutputType, ToolEventT = ToolEventType> extends Tool<ToolOutputT, ToolEventT> {
  ...
  _call(input: string, // DynamicTool's _call specifically expects a string after schema transformation
    runManager?: CallbackManagerForToolRun, parentConfig?: ToolRunnableConfig): Promise<ToolOutputT> | AsyncGenerator<ToolEventT, ToolOutputT>;
}
/**
