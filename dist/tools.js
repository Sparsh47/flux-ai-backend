...
const subtractTool = tool(async ({ a, b }) => {
...
const toUpperCaseTool = tool(async ({ text }) => {
...
const toLowerCaseTool = tool(async ({ text }) => {
...
const getLengthTool = tool(async ({ text }) => {
...
`,
    ...
    const chatFallback = tool(async ({ query: q }) => {
